...
const STATUS_FILTERS = [
  { id: 'all', name: 'ทั้งหมด', color: 'bg-gray-500', icon: ChefHat },
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">KDS - ครัว</h1>
                <p className="text-gray-600">จัดการออเดอร์อาหารจานหลัก</p>
              </div>
            </div>
        ...
        {filteredTickets.length > 0 ? (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-2">
              {selectedStatus === 'all' ? 'ไม่มีออเดอร์' : `ไม่มีออเดอร์${STATUS_FILTERS.find(s => s.id === selectedStatus)?.name}`}
            </h3>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-brand-primary">{statusCounts.all}</p>
              </div>
